...
- Vollständiger Acht-Varianten-SVG-Test einschließlich großer deckender Blanket-Ecken bestanden. `uploadDailyLimit.test.ts` prüft zusätzlich, dass Draft-Recoverywerte vor Publish/Draft-Verzweigung deklariert sind. Build und Architektur-Guard erforderlich vor Deployment. Nach Update Finalisierung erneut ausführen, um v6-Dateien zu erzeugen; alte Datei wird nicht automatisch gelöscht.
