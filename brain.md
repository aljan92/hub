...
- Nach einem realen PNG-Lauf ohne Fortschritt wurde die Brush-Vorbereitung weiter begrenzt: maximal 4.000 gleichmäßig deterministisch verteilte Stempel und vier statt zehn Vollflächen-Pässe. Jede Vorbereitungsphase und jede Formatvariante schreibt nun ein eigenes `FINALIZATION_EVENT`. Das begrenzt pathologische detailreiche PNGs und macht lange Renderabschnitte im Prompt Log sichtbar.
