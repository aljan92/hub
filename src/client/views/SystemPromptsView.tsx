...
const PROMPT_DEFINITIONS: PromptDefinition[] = [
  ...
  // ----------------------------------------------------
  {
    ...
    shortDesc: 'Generiert optimierte, drucktaugliche Bildprompts passend zum ausgewählten Bildprovider.',
  ...
  },
  {
    ...
    category: 'SHARED',
    title: 'Trademark Referee (konfiguriertes Modell)',
  ...
  },
  {
    ...
    category: 'SHARED',
    title: 'Adversarial Amazon Verifier (konfiguriertes Modell)',
