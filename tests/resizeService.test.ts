...
async function runResizeTests() {
  ...
  // Test 5: Verify all 4 output paths exist
  ...
  // Test 7: Verify 300 DPI chunk is present in all 4 outputs
  ...
  // Test 8: Verify Brush variant is distinct from Standard variant (Brush adds contour)
